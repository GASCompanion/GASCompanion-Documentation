---
title: Configuration for Attributes clamping
description: GAS Companion Configuration for Attributes clamping
eleventyNavigation:
    parent: Configuration
    key: Configuration for Attributes clamping
    excerpt: GAS Companion Configuration for Attributes clamping
    order: 1
layout: layouts/page
---
