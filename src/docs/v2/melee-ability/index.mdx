...
Introduced in 2.0.0 version of the plugin, `GSCGameplayAbility_MeleeBase` is a GameplayAbility Blueprint you can subclass and quickly create melee combo for your characters.
