...
Example maps are managed in their [own plugin](https://github.com/GASCompanion/GASCompanionExamples), and can be enabled / disabled at will. You can use the `Install Plugin` button in this window to automatically download and install it as a project plugin.
