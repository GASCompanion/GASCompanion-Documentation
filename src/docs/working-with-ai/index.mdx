...
Once done, don't forget to configure your Character Abilities, Attributes and Effects if you have them, like we did in the [Getting Started section](/getting-started).
