...
`GSCCoreComponent` in v3 is not added to the new Modular Actors classes by default, which means that is something you need to do manually in your Blueprints. 
